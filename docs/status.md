# Status — Four-Port USB 3.x Hub

**Not designed.** Benchmark board 25 of 32, at
scaffolding stage.
...
| Fixed requirements extracted | 18, each bound to verbatim brief text |
| Open decisions recorded | 18, none answered |
